	...
	#tag Method, Flags = &h0
		Sub populateListObjects()
		  ...
		  if popCategory.Text = "User Interface" then
		    ...
		    listObjects.AddRow "Set Page Background"
		    'listObjects.AddRow "About Box"
		    'listObjects.AddRow "System Notification"
		  end if
		  
		  // UI
		  if popCategory.Text = "Animation" then
		    colorBlockList = kcolAnimation
		    listObjects.AddRow "Move"
		    listObjects.AddRow "Resize"
		    listObjects.AddRow "Opacity"
		    //listObjects.AddRow "Pulsate"
		    listObjects.AddRow "Shake"
		    //listObjects.AddRow "Fade In"
		    //listObjects.AddRow "Fade Out"
		  end if
		  ...
		  if popCategory.Text = "Dictionaries" then
		    ...
		    listObjects.AddRow "Save Dictionary"
		    listObjects.AddRow "Load Dictionary"
		  end if
		  ...
		  if popCategory.Text = "Logic" then
		    ...
		    listObjects.AddRow "Which Target"
		  ...
		  if popCategory.Text = "Networking" then
		    colorBlockList = kcolSystem
		    listObjects.AddRow "Open URL"
		    listObjects.AddRow "Get URL Parameter"
		  end if
		  ...
		  if popCategory.Text = "Graphics" then
		    colorBlockList = kcolPicture
		    listObjects.AddRow "Set Pen Color"
		    listObjects.AddRow "Set Pen Font"
		    listObjects.AddRow "Set Pen Font Size"
		    listObjects.AddRow "Set Pen Text Allignment"
		    listObjects.AddRow "Set Canvas Picture"
		    listObjects.AddRow "Draw String on Canvas"
	...
	#tag Event
		Sub Action(item As ToolItem)
		  ...
		  case "toolBuild"
		    ...
		    dim m2 as MenuItem
		    m2 = new MenuItem("Build HTML5 - Desktop")
		    m.Append m2
		    
		    dim m3 as MenuItem
		    m3 = new MenuItem("Build HTML5 - Phone")
		    m.Append m3
		    
		    dim m4 as MenuItem
		    m4 = new MenuItem("Build HTML5 - Tablet")
		    m.Append m4
		    ...
		    if mr <> nil then
		      ...
		      if mr.Text = "Build HTML5 - Desktop" then
		        if modPrefs.isRegGood = false then
		          modPrefs.ShowUnregisteredDialog
		          Return
		        end if
		      ...
		      if mr.Text = "Build HTML5 - Phone" then
		        if modPrefs.isRegGood = false then
		          modPrefs.ShowUnregisteredDialog
		          Return
		        end if
		      ...
		      if mr.Text = "Build HTML5 - Tablet" then
		        if modPrefs.isRegGood = false then
		          modPrefs.ShowUnregisteredDialog
		          Return
		        end if
		  ...
		  case "toolRun"
		    ...
		    mRun2 = new MenuItem("Run HTML5 - Desktop")
		    mRun.Append mRun2
		    
		    dim mRun3 as MenuItem
		    mRun3 = new MenuItem("Run HTML5 - Phone")
		    mRun.Append mRun3
		    
		    dim mRun6 as MenuItem
		    mRun6 = new MenuItem("Run HTML5 - Tablet")
		    mRun.Append mRun6
		    ...
		    if mrRun <> nil then
		      ...
		      if mrRun.Text = "Run HTML5 - Tablet" then
		        if modPrefs.isRegGood = false then
		          modPrefs.ShowUnregisteredDialog
		          Return
		        end if
		        NewRunProjectHTML5(app.kTargetTablet)
		      end if
		      
		      if mrRun.Text = "Run HTML5 - Phone" then
		        if modPrefs.isRegGood = false then
		          modPrefs.ShowUnregisteredDialog
		          Return
		        end if
		        NewRunProjectHTML5(app.kTargetPhone)
		      end if
		      
		      if mrRun.Text = "Run HTML5 - Desktop" then
		        if modPrefs.isRegGood = false then
		          modPrefs.ShowUnregisteredDialog
		          Return
		        end if
		        NewRunProjectHTML5(app.kTargetDesktop)
		      end if
		      
		      if mrRun.Text = "Run HTML5 - Web" then
		        NewRunProjectHTML5(app.kTargetWeb)
		      end if
